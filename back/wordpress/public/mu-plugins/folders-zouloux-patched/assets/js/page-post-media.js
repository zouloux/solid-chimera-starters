(function (factory) {
    ...
    $(document).ready(function(){
        ...
        $(".media-frame:not(.hide-router) .attachments-browser li.attachment").draggable({
            revert: "invalid",
        ...
        //
        $(".tree-structure .folder-item").droppable({
            accept: ".wcp-move-file, .wcp-move-multiple, .attachments-browser li.attachment",
